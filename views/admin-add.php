                ...
                <form action="../controllers/adminController.php" method="post">
                    <div class="column">
                        ...
                        <div class="input-group">
                            ...
                            <input name="title" type="text" placeholder="e.g. Waston" required>
                        </div>

                        <!-- Cover -->
                        <div class="input-group">
                            <label for="cover">Cover</label>
                            <input name="cover" type="text" placeholder="e.g. book name.jpeg/png/jpg" required>
                        </div>

                        <!-- Price -->
                        <div class="input-group">
                            <label for="price">Price</label>
                            <input name="price" type="text" placeholder="e.g. 10.99" required>
                        </div>

                        <!-- Author -->
                        <div class="input-group">
                            <label for="author">Author</label>
                            <input name="author" type="text" placeholder="e.g. James Carl" required>
                        </div>

                        <!-- IBSN -->
                        <div class="input-group">
                            <label for="ibsn">IBSN</label>
                            <input name="ibsn" type="text" placeholder="e.g. IBSN3492923222" required>
                        </div>
                    ...
                    <div class="column">
                        ...
                        <div class="input-group">
                            ...
                            <input name="publication" type="text" placeholder="e.g. 29 Oct 2023" required>
                        </div>

                        <!-- Dimensions -->
                        <div class="input-group">
                            <label for="dimensions">Dimensions</label>
                            <input name="dimensions" type="text" placeholder="e.g. 239x03x19 mm" required>
                        </div>

                        <!-- Publisher -->
                        <div class="input-group">
                            <label for="publisher">Publisher</label>
                            <input name="publisher" type="text" placeholder="e.g. Connorstone" required>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input name="background-color" type="text" placeholder="e.g. #C2E1E9" required>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input name="genres" type="text" placeholder="e.g. self-motivation" required>
                    </div>

                    <div class="description">
                        <label for="description">Description</label>
                        <textarea name="description" cols="140" rows="10"></textarea>
                    </div>


                    <div class="form-action">
                        <button type="submit" id="add-now" name="insert">
                            Add Now
                        </button>
